...
$ti-icon-brand-unity: unicode('f2ac');
$ti-icon-brand-unsplash: unicode('edd8');
$ti-icon-brand-vcypress: unicode('f333');
...
$ti-icon-code-asterix: unicode('f312');
...
.#{$ti-prefix}-3d-rotate:before { content: $ti-icon-3d-rotate; }
...
.#{$ti-prefix}-brand-vcypress:before { content: $ti-icon-brand-vcypress; }
...
.#{$ti-prefix}-c-sharp:before { content: $ti-icon-c-sharp; }
...
.#{$ti-prefix}-code-asterix:before { content: $ti-icon-code-asterix; }
...
.#{$ti-prefix}-kering:before { content: $ti-icon-kering; }
...
.#{$ti-prefix}-uf-off:before { content: $ti-icon-uf-off; }
